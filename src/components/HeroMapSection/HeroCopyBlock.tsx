...
export default function HeroCopyBlock() {
  return (
    <div className="flex flex-col space-y-6 lg:space-y-8 text-center lg:text-left max-w-xl lg:max-w-none w-full">
      ...
      <h1 className="lg:hidden text-[3rem] mt-5 md:text-5xl font-extrabold tracking-tight text-gray-900 leading-[1.15] text-center">
        Find your room
        <br />
        <span className="text-[2rem] font-semibold text-brand-primary mr-2">on</span>
